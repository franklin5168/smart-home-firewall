...
#endif /* LOG */
{
    ...
    if (
        ( 
        interactions_data[0].current_state == 5 ||
    ...
    if (
        ...
        (interactions_data[0].current_state == 4 || interactions_data[0].current_state == 5)
        ) ||
        interactions_data[0].current_state == 1
        )
        && (
...
#endif /* LOG */
{
    ...
    if (!(interactions_data[0].counters + 3)->duration.is_initialized) {
        (interactions_data[0].counters + 3)->duration = counter_duration_init();
    }
    ...
    #endif
    if (
        (interactions_data[0].counters + 3)->duration.is_initialized &&
        ( 
        interactions_data[0].current_state == 3 ||
        interactions_data[0].current_state == 4
        )
        && (
        ...
        #ifdef DEBUG
        printf("stream-app-external#stun-bind-cam-server: State %hhu -> State 4\n", interactions_data[0].current_state);
        #endif
        interactions_data[0].current_state = 4;
        if (
(interactions_data[0].counters + 3)->duration.is_initialized && counter_read_microseconds() - (interactions_data[0].counters + 3)->duration.microseconds >= 1000000
        ) {
            ...
            #endif
            interactions_data[0].current_state = 5;
            (interactions_data[0].counters + 3)->duration.is_initialized = false;
        }
...
#endif /* LOG */
{
    ...
    if (
        ...
        // Policy is transient, increment state to indicate the transient policy is ongoing
        #ifdef DEBUG
        printf("stream-app-external#stun-bind-cam-server-backward: State %hhu -> State 4\n", interactions_data[0].current_state);
        #endif
        interactions_data[0].current_state = 4;
        if (
(interactions_data[0].counters + 3)->duration.is_initialized && counter_read_microseconds() - (interactions_data[0].counters + 3)->duration.microseconds >= 1000000
            ...
            // Increment state to indicate the transient policy is over
            #ifdef DEBUG
            printf("stream-app-external#stun-bind-cam-server-backward: State %hhu -> State 5\n", interactions_data[0].current_state);
            #endif
            interactions_data[0].current_state = 5;
            (interactions_data[0].counters + 3)->duration.is_initialized = false;
        }
...
#endif /* LOG */
{
    ...
    if (
        ...
        (interactions_data[0].counters + 3)->duration.is_initialized = false;
        #ifdef DEBUG
        printf("Reset duration counter for interaction 0 and policy 3\n");
        #endif
...
int main(int argc, char const *argv[]) {
    ...
    interactions_data[0].num_states = 6;
