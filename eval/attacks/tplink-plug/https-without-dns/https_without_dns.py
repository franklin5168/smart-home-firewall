...
"""
Attack towards the `dns-https-tplinkcloud` policy of the TP-Link smart plug.
Issue commands to the smart plug, which has not issued a DNS request beforehand,
by sending HTTPS packets with the following signature:
...
### GLOBAL VARIABLES ###
server_name = "euw1-api.tplinkra.com"
